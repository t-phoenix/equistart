...
const ivote=artifacts.require("IVotes");
...
module.exports =  (deployer)=> {
  ...
  deployer.deploy(ivote).then(()=>{
   return deployer.deploy(timelockController,11,proposers,executors).then(()=>{
     return deployer.deploy(mygo,ivote.address,timelockController.address);
   })
  })
};