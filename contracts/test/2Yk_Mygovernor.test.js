...
//         bountyProposal = await instance.propose([accounts[0]], [10000000], ["0x0000000000000000000000000000000000000000"], "Transfer funds", { from: accounts[2] });
...
//         console.log("yes");
//         // Queue
//         bountyQueue = await instance.queue([accounts[0]], [10000000], ["0x0000000000000000000000000000000000000000"], descriptionHash, { from: accounts[2] });
...
//         calldata="0x776562332e6574682e73656e645472616e73616374696f6e287b66726f6d3a6163636f756e74735b305d2c746f3a6163636f756e74735b335d2c76616c75653a31303030303030307d29"
//         // Execution
//         bountyExecute = await instance.execute([accounts[0]], [10000000], ["0x0000000000000000000000000000000000000000"], descriptionHash, { from: accounts[2] });
